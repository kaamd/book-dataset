Если вы хотите, чтобы в вашем приложении Streamlit отображались только авторы и названия книг непосредственно из файла japanese_books (1).csv, без возможности выбора уникальных значений через multiselect, вы можете полностью удалить блок с выбором авторов. Вместо этого просто загрузите данные из CSV и отображайте все книги и их авторов.

Вот как вы можете изменить код, чтобы отобразить все книги и авторов:
